...
p1_assets = await agent(
  ...
  4. **特权资产识别（核心策略 — 优先找"别人挖不了"的目标）**
     - SRC 太多人挖，同质化严重。真正的洞在**特权资产**里：付费/认证/白名单才能用的核心业务功能（如企业微信/腾讯会议付费版、认证企业的开放接口）。命中任一信号即标 [特权资产]：
     · [付费/企业版] — 标题/JS 含"企业版/专业版/旗舰版/付费/会员/VIP/认证/专属/私有化/授权/开通"
     · [认证/白名单] — 开放平台/开放 API 需认证或 AppKey；登录后才有完整功能
